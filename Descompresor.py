...
def decompress():
    ...
    with open("comprimido.elmejorprofesor", 'rb') as file, open("clave.elmejorprofesor", "rb") as key, open(output_path, 'w') as output:
        start = time.time()
        ...
        print("Archivo descomprimido: ", output_path)
